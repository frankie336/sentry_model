...
from ForexMastermind.ML.tools import SampleData, DataFrameSaver, ModelVersionService, Balance, DataLoader
...
class DataPreprocessor:
    ...
    def preprocess_data(self, unprocessed_training_data):
        ...
        training_data = self._balance_dataset(data=unprocessed_training_data)
        ...
        print('FROM INSIDE preprocess_data')
        print(training_data)
        print(X_train_res)
...
class TrainingPipeline:
    ...
    def run(self, model_notes='None', sample_size=0.1):

        # Load and process data
        data_loader = DataLoader(self.file_path)
        unprocessed_training_data = data_loader.load_data()
        ...
        # We need to return the mode & training time here  for later use in evaluation
